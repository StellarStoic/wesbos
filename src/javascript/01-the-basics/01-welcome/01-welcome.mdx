...
First one is the starter files for this course can be found at https://courses.wesbos.com/. Click through to `My Account` and there will be a link to the starter files.
